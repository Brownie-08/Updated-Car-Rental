...
PAYSTACK_MODE = env('PAYSTACK_MODE', default='test')  # 'test' or 'live'

# Currency Configuration
USE_LIVE_EXCHANGE_RATES = env.bool('USE_LIVE_EXCHANGE_RATES', default=True)
EXCHANGE_RATE_CACHE_DURATION = env.int('EXCHANGE_RATE_CACHE_DURATION', default=3600)
